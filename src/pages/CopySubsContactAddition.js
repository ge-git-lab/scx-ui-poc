...
import AddDataFormCopySubsContactAddition from '../component/AddDataFormCopySubsContactAddition';
...
const CopySubsContactAddition = () => {
  ...
  const fetchDataAndSetState = async () => {
      try {
        const result = await fetchData('https://t2635htwi8.execute-api.us-east-1.amazonaws.com/scx-dq-rem/dsp-copysubscontactaddition');
  ...
  const handleSaveData = async (data) => {
    try {
      await saveData('https://t2635htwi8.execute-api.us-east-1.amazonaws.com/scx-dq-rem/dsp-copysubscontactaddition', data);
      fetchDataAndSetState();
    } catch (error) {
  ...
  const handleDeleteData = async (idToDelete) => {
    try {
      const result = await deleteData('https://t2635htwi8.execute-api.us-east-1.amazonaws.com/scx-dq-rem/dsp-copysubscontactaddition', idToDelete)
      console.log(result)
  ...
  const importDataInCSV = async () => {
    ...
    csvLink.download = 'copy_subs_contact_addition.csv';
    csvLink.click();
    fetchDataAndSetState();
  ...
  const handleImport = async () => {
    try {
      const response = await exportData('https://t2635htwi8.execute-api.us-east-1.amazonaws.com/scx-dq-rem/dsp-copysubscontactaddition/importexport');
    ...
    try {
      ...
      if (fileInput && fileInput.files.length > 0) {
        ...
        fileReader.onload = () => {
          ...
          console.log(csvData)
          importData('https://t2635htwi8.execute-api.us-east-1.amazonaws.com/scx-dq-rem/dsp-copysubscontactaddition/importexport', csvData);
        }
  ...
  const handleDeleteAll = async () => {
    try {
      const response = await deleteAllData('https://t2635htwi8.execute-api.us-east-1.amazonaws.com/scx-dq-rem/dsp-copysubscontactaddition/importexport', {});
  ...
  const handleUpdateProcedure = async () => {
    try {
      const result = await callProcedure('https://t2635htwi8.execute-api.us-east-1.amazonaws.com/scx-dq-rem/dsp-copysubscontactaddition/updateprocedure');
      fetchDataAndSetState();
      console.log(result)
  ...
  const handleStageProcedure = async () => {
    try {
      const result = await callProcedure('https://t2635htwi8.execute-api.us-east-1.amazonaws.com/scx-dq-rem/dsp-copysubscontactaddition/stageprocedure');
      fetchDataAndSetState();
      console.log(result)
  ...
  return (
    <div className="col-12 d-flex flex-column" style={{ minHeight: '100vh' }}>
      <Header title="Copy Subs Contact Addition" />
      ...
      <div className='scrollable-content flex-grow-1 overflow-auto'>
        <div className='table-content mt-3'>
          ...
          <AddDataFormCopySubsContactAddition
            show={showAddForm}
            editData={editData}
...
export default CopySubsContactAddition;
